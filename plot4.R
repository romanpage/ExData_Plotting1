...
par(mfrow = c(2,2), mar = c(4,4,1,2), par(oma=c(1,1,1,1)), cex = 0.7)
plot(epcData2$datetime, epcData2$Global_active_power, type = "l", xlab="", ylab = "Global Active Power")
plot(epcData2$datetime, epcData2$Voltage, type = "l", xlab="datetime", ylab = "Voltage")
...
plot(epcData2$datetime, epcData2$Global_reactive_power, type = "l", xlab="datetime", ylab = "Global_reactive_power")
dev.off()
